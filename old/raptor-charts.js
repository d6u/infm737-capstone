//the function for the temperature graph
var makeTemperatureGraph = function(temperatures, date, temperature, location) {
  ...
  //turning the date in the data into a Date object
