...
'use strict';
    ...
    //
    // var temperatures = [
    //     {created_at: '2011-09-01T18:48:00.000Z', temperature: 98.6 , pulse: 80},
    //     {created_at: '2011-09-01T22:48:00.000Z', temperature: 99.8 , pulse: 82},
    //     {created_at: '2011-10-03T06:48:00.000Z', temperature: 97.6 , pulse: 84},
    //     {created_at: '2011-10-03T17:48:00.000Z', temperature: 101.2, pulse: 81},
    //     {created_at: '2011-10-03T22:48:00.000Z', temperature: 98.6 , pulse: 75},
    //     {created_at: '2011-10-05T22:48:00.000Z', temperature: 103.4, pulse: 90},
    //     {created_at: '2011-10-06T09:48:00.000Z', temperature: 102.1, pulse: 91},
    //     {created_at: '2011-10-06T20:48:00.000Z', temperature: 98.6 , pulse: 87},
    //     {created_at: '2011-10-06T22:48:00.000Z', temperature: 99.8 , pulse: 85},
    //     {created_at: '2011-10-07T13:48:00.000Z', temperature: 97.6 , pulse: 85},
    //     {created_at: '2011-10-07T15:48:00.000Z', temperature: 101.2, pulse: 82},
    //     {created_at: '2011-10-07T22:48:00.000Z', temperature: 98.6 , pulse: 82},
    //     {created_at: '2011-10-08T09:48:00.000Z', temperature: 103.4, pulse: 82},
    //     {created_at: '2011-10-08T22:48:00.000Z', temperature: 102.1, pulse: 80}];
    ...
    var PADDING = {TOP: 20, RIGHT: 35, BOTTOM: 120, LEFT: 40},
        ...
        BAR = {INNER_MARGIN: 1, OUTER_MARGIN: 2, CIRCLE_STROKE_WIDTH: 2},
        MAX_DATA_COUNT = 61,
        // DOUBLE_Y_AXIS = true,
        NUM_DATA_GROUP = 2;
    ...
    var dataGroup    = [temperatures, pulses];

    var x = d3.scale.ordinal()
        .domain(getXDomain(temperatures, pulses))
        .rangeBands([0, INNER_WIDTH], 0, 0.5);

    function getGroupRangeBand() {
        return x.rangeBand() / NUM_DATA_GROUP;
    }
    ...
    function parseLine(data, groupIndex) {
        ...
        for (var i = 1; i < data.length; i++) {
            ...
            if (d.type === 'gap') {
                ...
                startX = x(prevIndex) + BAR.OUTER_MARGIN +
                    (BAR.INNER_MARGIN + getGroupRangeBand()) * groupIndex +
                    getGroupRangeBand() / 2;

                endX = x(i) + BAR.OUTER_MARGIN +
                    (BAR.INNER_MARGIN + getGroupRangeBand()) * groupIndex +
                    getGroupRangeBand() / 2;
    ...
    dataPoint
        ...
        .attr('d', function(d, i) {
            if (d.type !== 'gap') {
                var w1 = x.rangeBand() - BAR.INNER_MARGIN * 2
